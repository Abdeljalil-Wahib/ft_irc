...
class Server
{
	private:
		...
		void handleKickCommand(Client *client, const std::string& args);
		void handleInviteCommand(Client *inviter, const std::string& args);
		void handleTopicCommand(Client *client, const std::string& args);
		void handleModeCommand(Client *client, const std::string& args);
		void handleQuitCommand(Client *client, const std::string& args);
